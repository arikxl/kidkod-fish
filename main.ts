sprites.onOverlap(SpriteKind.Food, SpriteKind.Food, function (sprite, otherSprite) {
    if (sprite.scale >= otherSprite.scale) {
        sprite.scale += 0.05
...
game.onUpdateInterval(2000, function () {
    ...
    fish2.scale = 0.9
    fish2.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
})
game.onUpdateInterval(1000, function () {
    fish.setVelocity(randint(0, 20), randint(0, 20))
    fish.setBounceOnWall(true)
})
game.onUpdateInterval(1100, function () {
    fish2.setVelocity(randint(0, 20), randint(0, 20))
